      ...
      <div className="space-y-2 p-2">
        {topic.documents?.map((doc, i) => (
          <div key={doc.id} className="flex items-start gap-2 rounded-lg border bg-background p-2">
            <FileText className="mt-2 h-4 w-4 shrink-0 text-blue-500" />
            <div className="flex-1 space-y-2">
              <Input
                ...
                className="h-9 border-0 bg-muted/30 focus-visible:ring-1"
              />
              <label className="flex h-9 cursor-pointer items-center gap-2 rounded-md bg-muted/30 px-3 text-sm text-muted-foreground hover:bg-muted transition-colors">
          ...
          <div key={v.id} className="flex items-start gap-2 rounded-lg border bg-background p-2">
            ...
            <div className="flex-1 space-y-2">
              <Input
                ...
                className="h-9 border-0 bg-muted/30"
              />
              <Input
