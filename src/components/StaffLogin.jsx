...
import { loginStaff } from '@/api/staff.api';
        ...
        >
          ...
          <div className='w-full lg:w-[330.67px] flex flex-col gap-1'>
            ...
            <input
              ...
              className='w-full h-[38px] sm:h-[40px] rounded-[8px] bg-gray-200 px-3 outline-none focus:ring-2 focus:ring-blue-500/20 transition-all'
            />
